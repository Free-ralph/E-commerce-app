...
def render_vite_bundle():
    ...
    return mark_safe(
        f"""<script type="module" src="https://topshop.s3.amazonaws.com/{manifest['index.html']['file']}"></script>
        <link rel="stylesheet" type="text/css" href="https://topshop.s3.amazonaws.com/{manifest['index.html']['css'][0]}" />
        """
    )